...
import kr.ac.yonsei.it.cse3009.sort.impl.Factory3;
...
public class Client {
	public static void main(final String[] args) {
		...
		// If Factory is not a Singleton.
		//	final ISort<String> s2 = new Factory().getSortAlgorithm();
		//	System.out.println(s2.sort(l));

		// If Factory is a Singleton (third implementation, using a member class).
		final ISort<String> s3 = Factory3.getInstance().getSortAlgorithm();
		System.out.println(s3.sort(l));
	}
}
